describe("Tests car service", () => {
    describe("isItExpensive", () => {
      it("should return message for higher cost when given Engine or Transmition as a parameter", () => {
        assert.equal(
      ...
      it("should return message for higher price when given a parameter that is not Engine or Transmition", () => {
        assert.equal(
    ...
    describe("discount", () => {
      it("should appy the correct discount", () => {
      ...
      it("should throw error when not viven numbers", () => {
    ...
    describe("partsToBuy", () => {
      it("should throw error when given invalid parameters", () => {
        assert.throw(
